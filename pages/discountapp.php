...
<head>
    ...
    <title>Discount Applications | FastFare</title>
    ...
    <div class="content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Discount Applications</li>
            </ol>
        </nav>
                        ...
                        echo '
                            ...
                            <div class="d-flex">
                                <div>
                                    ...
                                    <input type="text" class="form-control" value="'.$faker->randomElements(['Student', 'Senior Citizen', 'PWD'])[0].'">
                                </div>
                                <div>
                            ...
                            <div class="d-flex">
                                <div>
                                    <label for="">Supporting Document</label><br>
                                    <img src="'.$faker->imageUrl(360, 360, 'Supporting', false, 'Document', true, 'png').'" alt="">
                                </div>
                            </div>
                        ';
                        ?>
...
<script>
    ...
    $("#navDiscounts").addClass("active");
    $("#navDiscounts").removeClass("link-dark");
</script>
<script type="module">
    import {
        Toaster,
    ...
    for (const btn of btns) {
        ...
        btn.addEventListener("click", (e) => {
            var msg = type == "SUCCESS" ? "Successfully Approved Discount Application!" : "Successfully Rejected Discount Application";
